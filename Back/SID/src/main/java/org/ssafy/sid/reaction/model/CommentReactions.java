...
public class CommentReactions {
	...
	@ManyToOne(fetch = FetchType.LAZY, optional = false)
	@JoinColumn(name = "comment_id", columnDefinition = "INT(11) UNSIGNED", nullable = false)
	...
	public void update(CommentReactionsUpdateDTO commentReactionsUpdateDTO) {
		this.positive = commentReactionsUpdateDTO.getPositive();
	}
}
